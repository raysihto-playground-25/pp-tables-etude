...
詳細な定義と考察は [User Story-Driven Development Handbook](../user-story-driven-development-handbook.ja.md) を参照。
...
ストーリーカードとユーザーストーリーに関する一般的・汎用的な概念については、[User Story-Driven Development Handbook](../user-story-driven-development-handbook.ja.md) を参照。
