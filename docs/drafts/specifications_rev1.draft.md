...
ユーザーストーリーカード (以下、ストーリーカード) は、プロダクト開発において「ユーザーの価値」にフォーカスし、プロダクトを正しい方向に進めるための重要なツールである。本節では、ストーリーカードの記述フォーマットと運用ルールを定義する。
...
**【yyy】: 実現したいこと (What)**
- ユーザーが達成したい目的や行動を動詞形式で記述する
- 具体的かつ明確に、ユーザー視点で記述する
- 実装手段ではなく、ユーザーの意図・目的を記述する

**【zzz】: 価値・目的 (Why)**
- なぜそれを実現したいのか、その背景にある価値や理由を記述する
...
**プロダクトバックログ:**
- ストーリーカードのリストはプロダクトバックログとして管理する
...
- **ユーザーストーリーカード (ストーリーカード)**: プロダクト開発において、ユーザーの視点から機能や価値を記述したカード。「【xxx】は、【yyy】したい。【zzz】(の) ために。」という固定フォーマットで記述される
- **ユーザーロール**: ストーリーカードにおける【xxx】の要素。ストーリーの主語となるユーザーの立場や役割を表す。定義済みリストから選択する
- **プロダクトバックログ**: ユーザーストーリーカードのリスト。プロダクトに実装すべき機能や改善を優先順位付けして管理する
