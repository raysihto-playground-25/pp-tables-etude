...
**重要な理解:**
- **ユーザーストーリー**は、開発時に管理される単位である
- **ストーリーカード**は、その中に含まれる「誰が・何を・なぜ」を表現する記法である
- ストーリーカード自体を単体で管理することはなく、常にユーザーストーリーの一部として扱う
...
- エンドユーザーの価値を最大化することを常に念頭に置き、作業の優先順位付けを行う
...
- **開発アイテム**は、開発管理ツール (GitHub Issues、Jira など) で管理される個別の作業単位を指す
- **チケット**とも呼ばれ、開発アイテムとチケットは等価な関係にある
...
3. **業界標準**: role/action/benefit は多くの開発チームで使用されている標準的なプレースホルダー
